...
const discussUrl = (slug) => `https://mobile.twitter.com/search?q=${
...
export default function PostLayout({ frontMatter, authorDetails, next, prev, children }) {
  ...
  const header = <>
    {cover && <div className='absolute bottom-0 w-full h-44 blur-2xl bg-white/50 dark:bg-gray-900/70' />}
    ...
    <SectionContainer>
      ...
      <article>
        <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
          ...
          <div
            className="pb-8 divide-y divide-gray-200 xl:divide-y-0 dark:divide-gray-700 xl:gap-x-6"
          >
